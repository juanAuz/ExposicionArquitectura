...
* G7 - Funciones del módulo de E/S
...
- Decodificación de órdenes, Datos
-Información del Estado, Reconocimiento de Dirección
...
** ¿Qué información le proporciona el CPU al DMA?
- Tipo de operación
- Dispositivo de entrada/salida
- Transferencia de datos
EL DMA detiene al procesador por un ciclo de bus, no lo interrumpe No guarda contexto.
...
** Señales
*Señales HOLD/HLDA (Controlaodr del DMA - CPU)*
...
- Dispone de 5 registros de control para programar y controlar la operación del DMA en cada uno de los canales.
